        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
          {products.map((product, i) => (
            ...
            >
              ...
              <div className="relative aspect-[4/3] bg-gradient-to-b from-slate-50 to-white p-4 flex items-center justify-center overflow-hidden border-b border-slate-100">
                ...
                <img 
                  src={product.image} 
                  alt={product.name} 
                  className="max-h-[90%] max-w-[90%] w-auto h-auto object-contain group-hover:scale-105 transition-transform duration-500 relative z-10 mix-blend-multiply"
                />
              </div>
